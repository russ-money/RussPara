...
/client/proc/karmashopmenu()
	...
	switch(karma_tab)
		if(0) // Job Unlocks
			...
			<a href='?src=[UID()];karmashop=shop;KarmaBuy=5'>Unlock Blueshield -- 20KP</a><br>
			<a href='?src=[UID()];karmashop=shop;KarmaBuy=9'>Unlock Security Pod Pilot -- 20KP</a><br>
			<a href='?src=[UID()];karmashop=shop;KarmaBuy=6'>Unlock Mechanic -- 20KP</a><br>
			<a href='?src=[UID()];karmashop=shop;KarmaBuy=7'>Unlock Magistrate -- 20KP</a><br>
			"}

		if(1) // Species Unlocks
			dat += {"
			<a href='?src=[UID()];karmashop=shop;KarmaBuy2=1'>Unlock Machine People -- 20KP</a><br>
			<a href='?src=[UID()];karmashop=shop;KarmaBuy2=2'>Unlock Kidan -- 20KP</a><br>
			<a href='?src=[UID()];karmashop=shop;KarmaBuy2=3'>Unlock Grey -- 20KP</a><br>
			<a href='?src=[UID()];karmashop=shop;KarmaBuy2=7'>Unlock Drask -- 20KP</a><br>
			<a href='?src=[UID()];karmashop=shop;KarmaBuy2=4'>Unlock Vox -- 20KP</a><br>
			<a href='?src=[UID()];karmashop=shop;KarmaBuy2=5'>Unlock Slime People -- 20KP</a><br>
