/mob/living/silicon/emote(act, m_type=1, message = null, force)
	...
	switch(act)
		...
		if("ping","pings","buzz","buzzs","buzzes","beep","beeps","yes","no", "buzz2", "fart", "farts")
	...
	switch(act)
		...
		if("fart", "farts")
			...
			message = "<B>[src]</B> emits a synthetic fart[M ? " at [M]" : ""]."
			playsound(src.loc, 'sound/effects/mob_effects/poo_robot.ogg', 50, 0)
			m_type = 2



		if("help")
			to_chat(src, "yes, no, beep, ping, buzz, scream, buzz2, fart")
