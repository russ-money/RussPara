...
/datum/controller/gameticker/proc/pregame()
	login_music = pick(\
	'sound/music/guitaridea.ogg',\
	'sound/music/Kourai.ogg',\
	'sound/music/Recollections10.ogg',\
	'sound/music/sh2dog.ogg',\
	'sound/music/silvagunnerrobocop.ogg',\
	'sound/music/tintin.ogg',\
	'sound/music/toto.ogg')
	do
