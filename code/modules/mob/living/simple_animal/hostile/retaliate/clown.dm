...
/mob/living/simple_animal/hostile/retaliate/clown/goblin/lessergoblin
	name = "clown goblin"
	...
	del_on_death = TRUE
	loot = list(/obj/item/clothing/mask/gas/clown_hat, /obj/item/clothing/shoes/clown_shoes, /obj/item/reagent_containers/food/snacks/grown/citrus/white)
