...
/datum/reagent/consumable/drink/whitejuice
	name = "White Juice"
	id = "whitejuice"
	description = "Pucker up buttercup."
	color = "#FFFFFF" // rgb: 255, 255, 255
	drink_icon = "glass_white"
	drink_name = "Glass of White juice"
	drink_desc = "A bright white drink. Smells like heart attacks."
	taste_message = "white juice"
